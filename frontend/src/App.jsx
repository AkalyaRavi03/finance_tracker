    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-stone-50 to-emerald-50/40 px-4 py-6 text-slate-800 sm:px-6 lg:px-10 lg:py-10">
      <div className="mx-auto max-w-7xl">
        <header className="mb-10 flex items-center justify-between border-b border-slate-200/80 pb-5">
          <div className="flex items-center gap-3"><span className="grid h-10 w-10 place-items-center rounded-xl bg-slate-900 text-white shadow-lg shadow-slate-900/15"><WalletCards size={21} /></span><span className="font-['Space_Grotesk'] text-xl font-bold tracking-tight">Finance tracker</span></div>
